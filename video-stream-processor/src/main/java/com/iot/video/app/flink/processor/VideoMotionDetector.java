...
public class VideoMotionDetector implements Serializable {	
	 ...
	 * @throws Exception
	 */
	public static VideoEventStringData detectMotion(String camId, Iterator<VideoEventStringData> frames, String outputDir, VideoEventStringData previousProcessedEventData) throws Exception {
	...
	private static void saveImage(Mat mat,VideoEventStringData ed,String outputDir){
		String imagePath = outputDir+ed.getCameraId()+"-T-"+ed.getTimestamp()+".png";
